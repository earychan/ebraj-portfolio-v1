  ...
  return (
    <>
      <nav className="responsive__nav">
        <div className="responsive__nav--logo">
          <img src={Memoji} alt="Memoji Ebraj" className="memoji" />
          <p className="home__section--version-tag">v1.0</p>
        </div>
      ...
      <div className={isOpen ? "show__content" : "hide__content"}>
        ...
        <ul className="show__content--list2">
          ...
          <li>
            <a href="https://twitter.com/ebraj_g" target="blank">
              <img src={TwitterLogo} alt="Twitter Logo" />
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/_anizh_g/" target="blank">
